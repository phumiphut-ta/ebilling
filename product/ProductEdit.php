      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="clearfix"></div>
            <?php
            $product=$database->get("product_detail", ['id','product_no','product_description'],['active'=>1,'id'=>$product_id]);
            ?>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="height: auto;">
                  <div class="x_title">
                    ...
                    <div class="x_content" >
                     <form id="form-company" data-parsley-validate class="form-horizontal form-label-left" action="ProductEdit_action.php" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input name="product_no" type="text" id="product_no" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $product['product_no']; ?>">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input name="product_description" type="text" id="product_description" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $product['product_description']; ?>">
                        </div>
                      </div>
